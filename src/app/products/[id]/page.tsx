  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
            <Link href="/" className="flex items-center text-sm text-gray-500 hover:text-[#137fec] transition-colors">
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-4 gap-3">
                    {['S', 'M', 'L', 'XL'].map((size) => (
                        <button key={size} className="py-3 border border-gray-200 rounded-lg text-sm font-medium hover:border-[#137fec] hover:text-[#137fec] hover:bg-blue-50 transition">
                            {size}
                        </button>
                    ))}
                </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 transform transition-all scale-100">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <div className="flex gap-3 w-full">
                    <button onClick={() => setShowDeleteModal(false)} className="flex-1 py-2.5 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition">
                        Cancel
                    </button>
                    <button onClick={confirmDelete} disabled={deleting} className="flex-1 py-2.5 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 shadow-md shadow-red-200 transition disabled:opacity-70 flex items-center justify-center gap-2">
